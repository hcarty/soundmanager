...
solution "soundmanager"
    ...
    configuration {"web"}
        ...
        buildoptions
        {
            "-DorxWEB_EXECUTABLE_NAME='\"soundmanager.wasm\"'",
        ...
        linkoptions
        {
            "--preload-file " .. copybase .. "/build/soundmanager.obr@/",
    ...
    configuration {"web", "Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && soundmanager -b ../build/soundmanager.obr"}
        postbuildcommands {"del " .. path.translate(copybase, "\\") .. "\\build\\soundmanager.obr"}

    configuration {"web", "not Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && ./soundmanager -b ../build/soundmanager.obr"}
        postbuildcommands {"rm " .. copybase .. "/build/soundmanager.obr"}
